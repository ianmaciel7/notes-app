...
- **Editor Architecture & Component Isolation**: See [`ADR-0007`](docs/decisions/0007-blocknote-rich-text-editor-integration-and-ladle-story-workbench.md) for BlockNote rich-text editor integration (`@blocknote/*`), SSR dynamic loading isolation, and visual verification in Ladle.
