...
**Application Shell**:
The root layout and structural framing that provides global typography, viewport setup, and theme context across the application.
_Avoid_: Frame, wrapper, master page, template

**Theme**:
The visual appearance mode (light, dark, or system-inherited) managed across the interface by the theme provider.
