...
export function GithubSignInButton({
  ...
  const isDisabled = Boolean(disabled || ui.state !== "idle" || loading);
...
export { GithubSignInButton as GitHubSignInButton };
export type { GithubSignInButtonProps as GitHubSignInButtonProps };
