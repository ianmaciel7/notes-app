...
const objectIconToneTextClass: Record<ObjectIconTone, string> = {
  amber: "text-[oklch(0.5708_0.1192_59.46)] dark:text-amber-400",
  blue: "text-[oklch(0.5035_0.1579_264.41)] dark:text-blue-400",
  cyan: "text-[oklch(0.4954_0.0774_186.74)] dark:text-cyan-400",
  emerald: "text-[oklch(0.4933_0.0939_167.09)] dark:text-emerald-400",
  gray: "text-[oklch(0.4289_0.0021_324.71)] dark:text-zinc-400",
  green: "text-[oklch(0.5327_0.1221_151.70)] dark:text-green-400",
  orange: "text-[oklch(0.5570_0.1387_43.21)] dark:text-orange-400",
  purple: "text-[oklch(0.5047_0.2017_295.51)] dark:text-purple-400",
  red: "text-[oklch(0.5060_0.1552_24.58)] dark:text-red-400",
  rose: "text-[oklch(0.5096_0.1640_12.19)] dark:text-rose-400",
  sky: "text-[oklch(0.4914_0.0976_237.18)] dark:text-sky-400",
};

const objectIconToneBadgeClass: Record<ObjectIconTone, string> = {
  amber:
    "border-[oklch(0.8790_0.1533_91.61)] bg-[oklch(0.9746_0.0399_94.73)] text-[oklch(0.5708_0.1192_59.46)] dark:border-white/10 dark:bg-[#181818] dark:text-amber-400",
  blue: "border-[oklch(0.8091_0.0957_251.83)] bg-[oklch(0.9513_0.0235_256.13)] text-[oklch(0.5035_0.1579_264.41)] dark:border-white/10 dark:bg-[#181818] dark:text-blue-400",
  cyan: "border-[oklch(0.8549_0.1251_181.11)] bg-[oklch(0.9678_0.0321_182.40)] text-[oklch(0.4954_0.0774_186.74)] dark:border-white/10 dark:bg-[#181818] dark:text-cyan-400",
  emerald:
    "border-[oklch(0.8452_0.1299_165.01)] bg-[oklch(0.9660_0.0361_163.39)] text-[oklch(0.4933_0.0939_167.09)] dark:border-white/10 dark:bg-[#181818] dark:text-emerald-400",
  gray: "border-[oklch(0.8643_0.0017_67.13)] bg-[oklch(0.9766_0.0016_67.01)] text-[oklch(0.4289_0.0021_324.71)] dark:border-white/10 dark:bg-[#181818] dark:text-zinc-400",
  green:
    "border-[oklch(0.8712_0.1363_154.48)] bg-[oklch(0.9732_0.0311_157.36)] text-[oklch(0.5327_0.1221_151.70)] dark:border-white/10 dark:bg-[#181818] dark:text-green-400",
  orange:
    "border-[oklch(0.8366_0.1165_66.28)] bg-[oklch(0.9668_0.0264_74.74)] text-[oklch(0.5570_0.1387_43.21)] dark:border-white/10 dark:bg-[#181818] dark:text-orange-400",
  purple:
    "border-[oklch(0.8112_0.1014_293.55)] bg-[oklch(0.9564_0.0229_293.96)] text-[oklch(0.5047_0.2017_295.51)] dark:border-white/10 dark:bg-[#181818] dark:text-purple-400",
  red: "border-[oklch(0.8077_0.1035_19.54)] bg-[oklch(0.9530_0.0218_17.35)] text-[oklch(0.5060_0.1552_24.58)] dark:border-white/10 dark:bg-[#181818] dark:text-red-400",
  rose: "border-[oklch(0.8097_0.1061_11.61)] bg-[oklch(0.9563_0.0218_13.86)] text-[oklch(0.5096_0.1640_12.19)] dark:border-white/10 dark:bg-[#181818] dark:text-rose-400",
  sky: "border-[oklch(0.8276_0.1013_230.34)] bg-[oklch(0.9654_0.0192_235.84)] text-[oklch(0.4914_0.0976_237.18)] dark:border-white/10 dark:bg-[#181818] dark:text-sky-400",
};
