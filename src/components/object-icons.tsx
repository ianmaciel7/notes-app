...
const objectIconToneTextClass: Record<ObjectIconTone, string> = {
  amber:
    "text-[oklch(0.5708_0.1192_59.46)] dark:text-[oklch(0.9243_0.1151_95.76)]",
  ...
  emerald:
    "text-[oklch(0.4933_0.0939_167.09)] dark:text-[oklch(0.9049_0.0895_164.20)]",
  ...
  orange:
    "text-[oklch(0.5570_0.1387_43.21)] dark:text-[oklch(0.9015_0.0729_70.69)]",
  purple:
    "text-[oklch(0.5082_0.1955_304.61)] dark:text-[oklch(0.9024_0.0605_306.66)]",
...
const objectIconToneBadgeClass: Record<ObjectIconTone, string> = {
  ...
  blue:
    "border-[oklch(0.8091_0.0957_251.83)] bg-[oklch(0.9513_0.0235_256.13)] text-[oklch(0.5035_0.1579_264.41)] dark:border-[oklch(0.6129_0.1750_259.87)] dark:bg-[oklch(0.3498_0.0543_269.40)] dark:text-[oklch(0.8823_0.0571_254.14)]",
  cyan:
    "border-[oklch(0.8651_0.1154_207.11)] bg-[oklch(0.9704_0.0314_204.11)] text-[oklch(0.4908_0.0793_218.94)] dark:border-[oklch(0.6766_0.1167_214.15)] dark:bg-[oklch(0.3007_0.0267_224.29)] dark:text-[oklch(0.9167_0.0772_205.09)]",
  emerald:
  ...
  gray:
    "border-[oklch(0.8643_0.0017_67.13)] bg-[oklch(0.9856_0.0016_67.00)] text-[oklch(0.3887_0.0052_301.05)] dark:border-[oklch(0.4918_0.0038_16.70)] dark:bg-[oklch(0.2987_0.0072_285.88)] dark:text-[oklch(0.9163_0.0017_67.07)]",
  green:
  ...
  red:
    "border-[oklch(0.8077_0.1035_19.54)] bg-[oklch(0.9530_0.0218_17.35)] text-[oklch(0.5060_0.1552_24.58)] dark:border-[oklch(0.6272_0.1917_24.54)] dark:bg-[oklch(0.3586_0.0571_20.25)] dark:text-[oklch(0.8845_0.0592_18.27)]",
  rose:
    "border-[oklch(0.8097_0.1061_11.61)] bg-[oklch(0.9563_0.0218_13.86)] text-[oklch(0.5096_0.1640_12.19)] dark:border-[oklch(0.6345_0.2004_15.44)] dark:bg-[oklch(0.3588_0.0694_1.78)] dark:text-[oklch(0.8925_0.0559_9.93)]",
  sky:
    "border-[oklch(0.8276_0.1013_230.34)] bg-[oklch(0.9654_0.0192_235.84)] text-[oklch(0.4914_0.0976_237.18)] dark:border-[oklch(0.6587_0.1360_235.85)] dark:bg-[oklch(0.3160_0.0372_234.47)] dark:text-[oklch(0.9014_0.0556_230.95)]",
};
