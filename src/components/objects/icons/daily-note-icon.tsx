...
export const DailyNoteIcon = React.forwardRef<SVGSVGElement, ObjectIconProps>(
  function DailyNoteIcon(props, ref) {
    return (
      <ObjectIcon ref={ref} data-icon="daily-note" {...props}>
        <path
          fill="currentColor"
...
DailyNoteIcon.displayName = "DailyNoteIcon";
export const CalendarIcon = DailyNoteIcon;
export const ObjectDailyNoteIcon = DailyNoteIcon;
