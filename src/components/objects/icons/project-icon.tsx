...
export const ProjectIcon = React.forwardRef<SVGSVGElement, ObjectIconProps>(
  function ProjectIcon(props, ref) {
    return (
      <ObjectIcon ref={ref} data-icon="project" {...props}>
        <path
          fill="currentColor"
...
export const ObjectProjectIcon = ProjectIcon;
