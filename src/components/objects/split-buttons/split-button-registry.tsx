...
import type { ObjectTypeSplitChipProps } from "./object-type-split-chip";
...
export const objectSplitButtonRegistry: Record<
  string,
  React.ComponentType<ObjectTypeSplitChipProps>
> = {
...
export function getObjectSplitButton(type: string): React.ComponentType<ObjectTypeSplitChipProps> {
...
export function ObjectSplitButtonDynamic({
  type,
  ...props
}: { type: string } & ObjectTypeSplitChipProps) {
