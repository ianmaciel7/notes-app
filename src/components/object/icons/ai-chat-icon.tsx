...
export const AiChatIcon = React.forwardRef<SVGSVGElement, ObjectIconProps>(
  function AiChatIcon(props, ref) {
    return (
      <ObjectIcon ref={ref} data-icon="ai-chat" {...props}>
        <path
          fill="currentColor"
...
export const ObjectAiChatIcon = AiChatIcon;
