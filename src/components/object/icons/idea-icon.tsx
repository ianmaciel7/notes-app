...
export const IdeaIcon = React.forwardRef<SVGSVGElement, ObjectIconProps>(
  function IdeaIcon(props, ref) {
    return (
      <ObjectIcon ref={ref} data-icon="idea" {...props}>
        <path
          fill="currentColor"
...
export const ObjectIdeaIcon = IdeaIcon;
