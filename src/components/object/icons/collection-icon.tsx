...
export const CollectionIcon = React.forwardRef<SVGSVGElement, ObjectIconProps>(
  function CollectionIcon(props, ref) {
    return (
      <ObjectIcon ref={ref} data-icon="collection" {...props}>
        <path
          fill="currentColor"
...
export const ObjectCollectionIcon = CollectionIcon;
