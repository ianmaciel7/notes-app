...
export type QuestionSplitButtonProps = ObjectSplitButtonVariantProps

export function QuestionSplitButton({
  type = 'question',
  label = 'Question',
  variant = 'violet',
  onLabelClick,
...
export const ObjectQuestionSplitButton = QuestionSplitButton
