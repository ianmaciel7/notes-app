...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-[8px] border-t border-[#e7e2dc] bg-[#faf9f7] p-4 sm:flex-row sm:justify-end dark:border-border dark:bg-muted/50",
        className
      )}
      {...props}
    >
