    ...
    <ContextMenuPrimitive.Portal>
      ...
      >
        <ContextMenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) min-w-36 overflow-x-hidden overflow-y-auto p-1 data-closed:overflow-hidden",
            floatingSurfaceBaseClass,
            floatingSurfaceClass,
            className
          )}
...
function ContextMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronRightIcon className={cn(controlIconClass, "ml-auto size-3.5")} />
    </ContextMenuPrimitive.SubmenuTrigger>
  )
}
