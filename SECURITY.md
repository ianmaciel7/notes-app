...
- Do not store secrets in documentation, OpenSpec artifacts, generated agent files, or generated graph artifacts.
...
GitHub CodeQL is configured in `.github/workflows/security.yml` for JavaScript and TypeScript on pull requests, weekly scheduled runs, and manual runs. Treat CodeQL alerts as security findings and triage them before release.
