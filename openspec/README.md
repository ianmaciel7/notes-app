...
| Product baseline | `define-object-studio-study-foundation` | Preserved product foundation | Generic object studio, AI capture, study workflow, and deterministic review scheduling |
