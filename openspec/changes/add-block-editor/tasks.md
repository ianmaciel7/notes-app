...
- [x] 4.4 Browser-verify slash positioning at ordinary, scrolled, and viewport-edge caret positions with no `(0,0)` fallback.
...
- [x] 4.13 Browser-verify handle geometry, actual top-level reordering from the visible grip, menu click, no post-drag menu click, tooltip copy, and touch/mobile fallback.
...
- [x] 5.3 Verify focus, reduced motion, mobile overflow, read-only semantics, and clean console behavior.
...
- [x] 6.2 Execute Playwright coverage for slash-after-text, caret anchoring, command execution, selection preservation, handle geometry/tooltips, insertion/reordering, persistence, accessibility, and reference screenshots.
