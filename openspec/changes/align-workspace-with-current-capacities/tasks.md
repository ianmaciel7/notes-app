...
- [ ] 7.4 Make search, filter, sort, layout, collapse, type settings, template, collection, and query commands render their named outcomes; remove test acceptance of `view not ready` placeholders.
...
- [ ] 7.9 Replace legacy-or-current selector fallbacks with production-view assertions and generate a command matrix covering pointer, keyboard, post-click render, reload, and unavailable states.
