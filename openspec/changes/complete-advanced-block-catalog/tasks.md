...
- [ ] 1.1 Add failing schema tests for every advanced node/interface, invalid attributes, depth limits, unknown nodes, and stable IDs.
- [ ] 1.2 Implement schema version 3, pure v2-to-v3 migration, normalization, serialization, and safe unsupported-node handling.
- [ ] 1.3 Add Markdown/native export tests with explicit lossiness for layouts and transclusion.
...
- [ ] 2.2 Implement highlight blocks with source metadata and safe import/render behavior.
...
- [ ] 4.3 Integrate advanced blocks into slash/plus catalogs and block menus without duplicate commands.
