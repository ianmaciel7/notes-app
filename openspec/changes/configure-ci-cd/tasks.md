...
- [x] Remove tracked `.pnpm-store` artifacts and ignore the local store.
- [x] Pin Node.js 22 and preserve pnpm 11.20.0.
- [x] Add repository verification scripts and baseline tests.
- [x] Add the `Quality` GitHub Actions workflow.
- [x] Add the `Security` CodeQL workflow.
- [x] Add Dependabot and CODEOWNERS.
- [x] Add safe `stag` to `dev` back-sync automation.
