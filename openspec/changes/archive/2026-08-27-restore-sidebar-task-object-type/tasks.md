...
- [x] 4.1 Run the complete `pnpm verify` suite in a full development checkout or CI.
- [x] 4.2 Sync the finalized delta into canonical specs and archive this change after full verification.
