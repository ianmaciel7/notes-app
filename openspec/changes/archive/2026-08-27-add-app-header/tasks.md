...
- [x] 5.4 Run the full repository verification workflow in CI or an executable development checkout.
- [x] 5.5 Run `openspec validate --specs` and archive the change after implementation verification.
