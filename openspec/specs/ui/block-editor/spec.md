...
## Purpose
Defines the first-slice block editor contract for structured documents, slash-command creation, selection toolbar behavior, top-level block controls, read-only rendering, localization, and acceptance evidence.
