# typed-property-values Specification

## Purpose
Defines canonical typed property values for default, metadata, runtime custom Structure, conversion, validation, and backward-compatible migration behavior.
