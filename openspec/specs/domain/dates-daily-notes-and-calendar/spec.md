# dates-daily-notes-and-calendar Specification

## Purpose
Defines canonical date semantics, Daily Note identity, calendar projections, day context, and date-driven navigation for local workspace objects.
