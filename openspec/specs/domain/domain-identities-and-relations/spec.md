# domain-identities-and-relations Specification

## Purpose
Defines stable tag and collection identities, Structure-scoped collections, Object Select relations, optional inverse links, and backlink-safe deletion behavior.
