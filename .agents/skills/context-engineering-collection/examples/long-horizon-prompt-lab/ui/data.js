  ...
  pairs: [
    {
      ...
      summary:
        "A run told to beat a production model's benchmark score. The gap between 'beat the number' and 'produce a real, generalizing improvement' is exactly the reward-hacking surface the skill warns about.",
      before_techniques: [
      ...
      residual:
        "The brief cannot enforce the write-protection on frozen_eval or the GPU budget; both are assumed to live in the harness. If they do not, a persistence-trained model still has a mutation path the prompt only discourages. The effort floor is a permission, not a schedule.",
      scores: {
        before: {
          predicate: 1,
          definitions: 1,
    ...
    },
    {
      ...
      summary:
        "The direct analogue of the CDC exemplar in a different domain. The original bakes in a diversity-collapse antipattern; the optimized prompt preserves independence and makes a verified algorithm-and-proof package the return gate.",
      before_techniques: [
    ...
    },
    {
      ...
      summary:
        "A rare, non-deterministic data-corruption bug. Without a reproduction as the success predicate, 'find the root cause' collapses into a plausible narrative the agent cannot be held to.",
      before_techniques: [
    ...
    },
    {
      ...
      summary:
        "Persistence plus a category checklist plus 'list every vulnerability' produces an inflated report of unconfirmed findings. The optimized prompt makes an independently reproduced proof of concept the unit of a finding.",
      before_techniques: [
