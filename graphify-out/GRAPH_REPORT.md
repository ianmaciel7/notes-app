...
Cohesion: 0.11
Nodes (24): ref_base_ui_react_separator, ref_firebase_auth, @firebase-oss/ui-core, @firebase-oss/ui-react, GithubSignInButton(), GithubSignInButtonProps, GoogleSignInButton(), GoogleSignInButtonProps (+16 more)
...
Cohesion: 0.07
Nodes (32): Overview and Architecture, Internationalization (i18n), embla-carousel-react, FirebaseProvider(), getMessage(), I18nContext, I18nContextValue, I18nProvider() (+24 more)

### Community 14 - "question-renderer.tsx"
Cohesion: 0.08
Nodes (37): ref_base_ui_react_checkbox, ref_base_ui_react_radio, ref_base_ui_react_radio_group, ref_next_image, DndQuestion(), DndQuestionProps, HotspotQuestion(), HotspotQuestionProps (+29 more)
...
Cohesion: 0.09
Nodes (26): ref_firebase_admin_app, ref_firebase_admin_auth, ref_firebase_admin_firestore, ref_next_link, ref_node_fs, ref_node_path, db, FixtureData (+18 more)
...
Cohesion: 0.03
Nodes (125): addManualContextText(), applyLiveBarPreference(), applyPlaceholderSizingStyles(), averageRgb01(), bindEditBadgeProxy(), bufferToBase64(), buildPlaceholderResizeHandles(), buildSvelteExpressionTextMap() (+117 more)
...
Cohesion: 0.07
Nodes (78): applyParamDefaults(), applyParamValue(), applyPlaceholderDimensions(), applySavedSessionMeta(), buildParamsPanel(), checkpointPayload(), clampVariantIndex(), closedClipPath() (+70 more)
...
Cohesion: 0.22
Nodes (11): ref_next_experimental_testing_server, ref_next_server, defaultLocale, localeCookieName, localeHeaderName, authPaths, config, isAuthPath() (+3 more)
...
Cohesion: 0.13
Nodes (21): ForgotPasswordPage(), SignInPage(), SignUpPage(), ForgotPasswordAuthForm(), onSubmit(), ForgotPasswordAuthScreen(), SignInAuthForm(), onSubmit() (+13 more)

### Community 31 - "getCurrentUser"
Cohesion: 0.14
...
### Community 38 - "renderDesignVisual"
Cohesion: 0.08
...
### Community 40 - "react"
Cohesion: 0.06
Nodes (36): ref_base_ui_react_avatar, ref_firebase_app, ref_firebase_database, ref_firebase_storage, @ladle/react, react, @testing-library/react, @testing-library/user-event (+28 more)
...
Cohesion: 0.11
Nodes (32): agentHasWorkInFlight(), agentStatusText(), barPaletteForTheme(), brandMarkSvg(), designPanelCss(), detectPageTheme(), ensureAgentPollTooltip(), fetchAgentPollingStatus() (+24 more)
...
Cohesion: 0.08
Nodes (54): applyGlobalBarLabelState(), armPageChatForTyping(), attachSteerFocusDebug(), attachSteerFocusGuard(), buildSteerProcessingDots(), buildSteerQueueHint(), clearSteerAwaitTimer(), clearSteerFocusRecoverTimer() (+46 more)

### Community 73 - "setLiveState"
Cohesion: 0.09
Nodes (60): applyEditing(), beginNewLiveConfiguration(), buildInsertPlaceholderSnapshotFromDom(), buildLocatorForLeaf(), buildPickedAnchorSnapshot(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure() (+52 more)
...
### Community 85 - "cn"
Cohesion: 0.05
Nodes (8): ref_base_ui_react_accordion, ref_base_ui_react_slider, ref_base_ui_react_switch, cn, ref_shadcn_react_message_scroller, ButtonGroup(), buttonGroupVariants, NativeSelectProps

### Community 87 - "enableInlineEdit"
Cohesion: 0.40
Nodes (5): collectEditableTextRows(), visit(), enableInlineEdit(), onInlineInput(), wrapMixedContentTextNodes()

### Community 88 - "bubble.tsx"
Cohesion: 0.28
Nodes (6): ref_base_ui_react_merge_props, ref_base_ui_react_use_render, Bubble(), BubbleReactions(), bubbleReactionsVariants, bubbleVariants
...
Cohesion: 0.11
Nodes (14): Architecture, Configuration, Data access and security, Structure, Subagents and agent automation, App-Owned Production Literals, Authentication Error Normalization, Boundary with Firebase UI Translations (+6 more)

### Community 116 - "showToast"
Cohesion: 0.08
Nodes (41): abandonForeignSession(), abandonSupersededGo(), abortSvelteComponentInjection(), cleanup(), clearHandled(), clearMountErrorCard(), clearScrollY(), clearSession() (+33 more)
...
Cohesion: 0.17
Nodes (17): Code Language Rule, Internationalization (Next.js App Router), Code Language Rule, Internationalization (Next.js App Router), ref_next_navigation, generateMetadata(), generateStaticParams(), LocaleLayout() (+9 more)

### Community 161 - "case-study-layout.tsx"
Cohesion: 0.29
...
### Community 167 - "lucide-react"
Cohesion: 0.09
Nodes (29): ref_base_ui_react_button, ref_base_ui_react_input, ref_hookform_resolvers_standard_schema, lucide-react, react-hook-form, MultiFactorAuthAssertionForm(), MultiFactorAuthAssertionFormProps, Policies() (+21 more)
...
Cohesion: 0.14
Nodes (22): ExamPractice(), PracticeLabels, saveQuestionNote(), recordQuestionAttempt(), toggleQuestionBookmark(), updateStudyGoals(), getActionUserId(), recordAttemptAction() (+14 more)

### Community 178 - "actOnAgentTarget"
Cohesion: 0.11
Nodes (41): actOnAgentTarget(), agentTargetBusyReason(), agentTargetOverlayGone(), agentTargetTaken(), claimAgentTarget(), claimAndActOnAgentTarget(), clearStoredManualApplyState(), declineAgentTargetBusy() (+33 more)
...
Cohesion: 0.11
Nodes (8): ref_base_ui_react_dialog, cmdk, Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogTitle()
...
### Community 215 - "mountSvelteComponentVariant"
Cohesion: 0.12
...
### Community 279 - "class-variance-authority"
Cohesion: 0.40
Nodes (3): class-variance-authority, Marker(), markerVariants

### Community 280 - "Task 3 Report — Client Component Dictionary Bridge"
Cohesion: 0.33
Nodes (5): Concerns, Scope confirmation, Status, Task 3 Report — Client Component Dictionary Bridge, Validation

## Knowledge Gaps
- **1516 isolated node(s):** `When to Prefer This Agent (Orchestration Guidance)`, `Component Architecture & Styling Rules`, `Verification Checklist`, `Project-installed core`, `Global on-demand skills` (+1511 more)
...
- **Why does `init()` connect `initGlobalBar` to `impeccable/SKILL.md`, `onAnnotDown`, `syncPageChatFocus`, `setLiveState`, `actOnAgentTarget`, `live-browser.js`, `connectSSE`, `new-work.md`, `live.md`, `Init flow`, `firebase-basics/references/ios_setup.md`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `sidebar.tsx`, `context-menu.tsx`, `menubar.tsx`, `package.json`, `question.tsx`, `sign-in-auth-screen.tsx`, `drawer.tsx`, `useI18n`, `question-renderer.tsx`, `chart.tsx`, `[examId]/page.tsx`, `toggle-group.tsx`, `attachment.tsx`, `class-variance-authority`, `item.tsx`, `getAuthErrorMessage`, `dictionaries.ts`, `alert-dialog.tsx`, `lucide-react`, `exam-actions.ts`, `table.tsx`, `app/layout.tsx`, `toast.tsx`, `command.tsx`, `cn`, `bubble.tsx`, `combobox.tsx`, `select.tsx`?**
...
- **What connects `When to Prefer This Agent (Orchestration Guidance)`, `Component Architecture & Styling Rules`, `Verification Checklist` to the rest of the system?**
